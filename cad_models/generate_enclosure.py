...
# 2.1 Szyny i łoże dla ESP32 DevKit V1 (Szerokość 29.2 mm, piny wiszą swobodnie w kanałach)
...
# 2.6 Otwory na 3 przyciski w dolnej brodzie (Średnica 6.2 mm z luzem suwliwym)
...
btn_dome = Part.makeSphere(2.4, Vector(0,0,5.4))
dome_box = Part.makeBox(6, 6, 3, Vector(-3, -3, 5.4))
